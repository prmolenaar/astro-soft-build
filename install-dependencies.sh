...
sudo apt install libnova-dev libcfitsio-dev libusb-1.0-0-dev zlib1g-dev libgsl-dev build-essential cmake git \
        ...
        pkg-config libev-dev libqt5datavisualization5-dev libzmq3-dev libudev-dev libopencv-dev libgmock-dev

[ "$1" == "phd2" ] && sudo apt install libwxgtk3.2-dev build-essential wx-common wx3.2-i18n libx11-dev libgtest-dev
